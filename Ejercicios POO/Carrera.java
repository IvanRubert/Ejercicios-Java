...
public class Carrera {
    public static void main(String[] args) {
        ...
        System.out.printf("Ejercicios_corregidos.Coche 1: %dm %nCoche 2: %dm %nCoche 3: %dm %nCoche 4: %dm %n", c1.longitudRecorrida(), c2.longitudRecorrida(), c3.longitudRecorrida(), c4.longitudRecorrida());
        switch (opcion){
            case 1:
